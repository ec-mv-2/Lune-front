...
const Button: React.FC<ButtonProps> = ({ type = 'button', variant, leftIcon, rightIcon, children, onClick }) => {
  const buttonStyles = {
    mainClear: "border border-lightBlueText text-darkBlueText py-10 lg:py-5 text-3xl lg:text-base w-96 lg:w-72 px-14 rounded flex items-center mt-3 justify-between",
    simple: "border border-lightBlueText text-darkBlueText py-10 lg:py-5 w-96 pl-5 lg:w-60 rounded flex items-center justify-between mt-3 text-3xl lg:text-base ",
    ...
    mediumSizeDark:"border border-lightBlueText bg-darkBlueText text-white py-3 w-44 rounded flex items-center justify-between mt-3 text-3xl lg:text-base",
    mediumSizeLight:'border border-lightBlueText text-darkBlueText py-3 w-44 rounded flex items-center justify-between mt-3 text-3xl lg:text-base',
  };
