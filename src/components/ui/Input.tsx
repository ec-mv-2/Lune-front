    ...
    if(location.pathname == "/Register"){
        ...
        return(
            <div className={`min-w-[40%]`}>
                ...
                <input {...props} className="border-[1px] peer border-blueText bg-whiteLight rounded-md h-9 w-full focus:outline-none px-3 py-6 focus:border-lightBlueText transition-all duration-200 disabled:bg-gray-400 read-only:cursor-not-allowed "/>
            </div>
        )
    }
